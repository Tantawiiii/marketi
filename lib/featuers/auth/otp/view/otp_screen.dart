      ...
      child: Scaffold(
        body: ListView(
          children: [
            ...
            verticalSpace(20),
            Text(
              TTexts.tVerificationCode,
              textAlign: TextAlign.start,
              style: AppTextStyles.font24BlackMedium,
            ),
            verticalSpace(20),
            Text(
              TTexts.tVerificationCodeSent,
              textAlign: TextAlign.start,
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: TColors.BORDER),
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: BorderSide(color: TColors.CPrimary,width: 2),
                      ),
                    ),
                    onChanged: (value) {
                      if (value.isNotEmpty) {
